...
install-minimal:
    ...
    if [ ! -f "$vcvarsall" ]; then
        ...
        echo ""
        echo "Checking VC/Auxiliary directory..."
        ls -la "{{wineprefix}}/drive_c/Program Files (x86)/Microsoft Visual Studio/2019/BuildTools/VC/Auxiliary" 2>/dev/null || echo "No Auxiliary directory found"
        echo ""
